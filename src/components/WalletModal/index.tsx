              ...
              <LightCard>
                <AutoRow style={{ flexWrap: 'nowrap' }}>
                  <ThemedText.Body fontSize={12}>
                    <Trans>
                      By connecting a wallet, you agree to CRDT Labs’{' '}
                      <ExternalLink
                      ...
                      and acknowledge that you have read and understand the CRDT{' '}
                      <ExternalLink style={{ textDecoration: 'underline' }} href="https://crdt.io">
                        Protocol Disclaimer
                      </ExternalLink>
                      .
                    </Trans>
